!function($, wysi) {
              ...
              "<div class='bootstrap-wysihtml5-insert-link-modal modal fade'>" +
               "<div class='modal-dialog'><div class='modal-content'>" +
                ...
                "<div class='modal-footer'>" +
                  ...
                  "<a href='#' class='btn btn-azul' data-dismiss='modal'>" + locale.link.insert + "</a>" +
                "</div>" +
               "</div></div>" +
              "</div>" +
              ...
              "<div class='bootstrap-wysihtml5-insert-image-modal modal fade'>" +
               "<div class='modal-dialog'><div class='modal-content'>" +
                ...
                "<div class='modal-footer'>" +
                  ...
                  "<a href='#' class='btn btn-azul' data-dismiss='modal'>" + locale.image.insert + "</a>" +
                "</div>" +
                "</div></div>" +
              "</div>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            ...
            var insertButton = insertImageModal.find('a.btn-azul');
        ...
        initInsertLink: function(toolbar) {
            ...
            var insertButton = insertLinkModal.find('a.btn-azul');
            var initialValue = urlInput.val();
            var caretBookmark;
