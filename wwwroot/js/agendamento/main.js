            ...
            $("#modalViagens").on("shown.bs.modal", function (event)
            {
                try
                {
                    ...
                    if (datePickerElement && datePickerElement.ej2_instances && datePickerElement.ej2_instances[0])
                    {
                        ...
                        console.log("✅ Data mínima ajustada");
                    }
                    ...
                    setTimeout(() =>
                    {
                        console.log('🎯 [MODAL] Configurando SELECT do requisitante DIRETAMENTE...');
                        ...
                        if (lstRequisitante)
                        {
                            ...
                            {
                                console.log('  ✅ ej2_instances existe');

                                const requisitanteObj = lstRequisitante.ej2_instances[0];

                                if (requisitanteObj)
                                {
                                    console.log('  ✅ Instância [0] encontrada');
                                    ...
                                    {
                                        console.log('🎉 [MODAL-SELECT] Evento SELECT disparou!');
                                    ...
                                    {
                                        console.log('🔍 [MODAL-CHANGE] Evento CHANGE disparou!');
                                    ...
                                    console.log('  ✅✅✅ [MODAL] Eventos configurados DIRETAMENTE com SUCESSO!');
                                }
                                else
                                {
                                    console.error('  ❌ Instância [0] não encontrada');
                                }
                            }
                            else
                            {
                                console.error('  ❌ ej2_instances não existe');
                            }
                        }
                        else
                        {
