...
var initApp = (function(app) {
	...
	app.domReadyMisc = function() {
		 ...
		 */
        // BS5: configure computeStyles.gpuAcceleration via popperConfig
        (function ()
        {
            if (!(window.bootstrap && (bootstrap.Dropdown || bootstrap.Popover)))
            {
                console.warn('Bootstrap 5 Dropdown/Popover não disponível.');
                return;
            }
